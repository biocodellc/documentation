...
# documentation.
#html_theme_options = { "relbarbgcolor": "white" }
...
# of the sidebar.
html_logo = 'images/BiocodeLogo.png'
...
htmlhelp_basename = 'FIMSdocumentationdoc'
...
latex_documents = [
    (master_doc, 'FIMSdocumentation.tex', u'FIMS documentation Documentation',
     u'John Deck, RJ Ewing', 'manual'),
]
